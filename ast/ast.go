...
func (ls *LetStatement) String() string {
	...
	out.WriteString(" " + tk.SymbolLiteral(tk.ASSIGN) + " ")

	if ls.Value != nil {
		out.WriteString(ls.Value.String())
	}
	out.WriteString(tk.SymbolLiteral(tk.SEMICOLON))
...
func (bs *BreakStatement) String() string {
	return tk.Current.Output.Break + tk.SymbolLiteral(tk.SEMICOLON)
}
...
func (cs *ContinueStatement) String() string {
	return tk.Current.Output.Continue + tk.SymbolLiteral(tk.SEMICOLON)
}
...
func (ie *IfExpression) String() string {
	...
	if ie.ElseIf != nil {
		out.WriteString(tk.KeywordLiteral(tk.ELSE))
		out.WriteString(" ")
...
func (fe *ForExpression) String() string {
	...
	out.WriteString(tk.SymbolLiteral(tk.LPAREN))
	if fe.Init != nil {
		out.WriteString(strings.TrimSuffix(fe.Init.String(), tk.SymbolLiteral(tk.SEMICOLON)))
	}
	out.WriteString(tk.SymbolLiteral(tk.SEMICOLON))
	if fe.Condition != nil {
	...
	out.WriteString(tk.SymbolLiteral(tk.SEMICOLON))
	if fe.Update != nil {
		out.WriteString(strings.TrimSuffix(fe.Update.String(), tk.SymbolLiteral(tk.SEMICOLON)))
	}
	out.WriteString(tk.SymbolLiteral(tk.RPAREN))
...
func (al *ArrayLiteral) String() string {
	...
	out.WriteString(tk.SymbolLiteral(tk.LBRACKET))
	out.WriteString(strings.Join(elements, comma))
	out.WriteString(tk.SymbolLiteral(tk.RBRACKET))
...
func (hl *HashLiteral) String() string {
	...
	for _, p := range hl.Pairs {
		pairs = append(pairs, fmt.Sprintf("%s%s%s", p.Key, tk.SymbolLiteral(tk.COLOMN), p.Value))
	}
