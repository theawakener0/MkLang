#!/bin/sh
#
# Install the latest MkLang binary from GitHub Releases.
#
...
asset="mklang_${os}_${arch}.tar.gz"
...
binary="${tmp}/mklang_${os}_${arch}/mklang"
...
install -m 0755 "${binary}" "${dest_dir}/mklang"
echo "Installed mklang to ${dest_dir}/mklang"
...
echo "Run 'mklang -version' to verify."
